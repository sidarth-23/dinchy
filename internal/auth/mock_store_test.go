...
// Source: github.com/sidarth-23/dinchy/internal/auth (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -destination=internal/auth/mock_store_test.go -package=auth github.com/sidarth-23/dinchy/internal/auth Store
//
