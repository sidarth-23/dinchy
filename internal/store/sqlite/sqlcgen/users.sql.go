...
func (q *Queries) FindPasswordAccountByUserID(ctx context.Context, userID string) (FindPasswordAccountByUserIDRow, error) {
...
const findPendingInvitationByEmailAndOrganisation = `-- name: FindPendingInvitationByEmailAndOrganisation :one
...
type FindPendingInvitationByEmailAndOrganisationParams struct {
	Email          string
	OrganisationID string
}

type FindPendingInvitationByEmailAndOrganisationRow struct {
	ID             string
	OrganisationID string
	Email          string
	Role           string
...
func (q *Queries) FindPendingInvitationByEmailAndOrganisation(ctx context.Context, arg FindPendingInvitationByEmailAndOrganisationParams) (FindPendingInvitationByEmailAndOrganisationRow, error) {
	row := q.db.QueryRowContext(ctx, findPendingInvitationByEmailAndOrganisation, arg.Email, arg.OrganisationID)
	var i FindPendingInvitationByEmailAndOrganisationRow
	err := row.Scan(
		&i.ID,
		&i.OrganisationID,
		&i.Email,
...
func (q *Queries) FindTwoFactorByUserID(ctx context.Context, userID string) (FindTwoFactorByUserIDRow, error) {
...
func (q *Queries) ListOrganisationsForUser(ctx context.Context, userID string) ([]ListOrganisationsForUserRow, error) {
