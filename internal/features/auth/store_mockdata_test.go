...
// Source: github.com/sidarth-23/dinchy/internal/platform/store/sqlcgen (interfaces: Querier)
//
// Generated by this command:
//
//	mockgen -destination=store_mockdata_test.go -package=auth -mock_names=Querier=MockStore github.com/sidarth-23/dinchy/internal/platform/store/sqlcgen Querier
//
...
// MockStore is a mock of Querier interface.
...
func (m *MockStore) EnsureDefaultSettings(ctx context.Context, arg sqlcgen.EnsureDefaultSettingsParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnsureDefaultSettings", ctx, arg)
	ret0, _ := ret[0].(error)
	return ret0
}

// EnsureDefaultSettings indicates an expected call of EnsureDefaultSettings.
func (mr *MockStoreMockRecorder) EnsureDefaultSettings(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnsureDefaultSettings", reflect.TypeOf((*MockStore)(nil).EnsureDefaultSettings), ctx, arg)
}
...
func (m *MockStore) InsertAuditLog(ctx context.Context, arg sqlcgen.InsertAuditLogParams) error {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAuditLogs(ctx context.Context, arg sqlcgen.ListAuditLogsParams) ([]sqlcgen.AppAuditLog, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAuditLogs", ctx, arg)
	ret0, _ := ret[0].([]sqlcgen.AppAuditLog)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListAuditLogs indicates an expected call of ListAuditLogs.
func (mr *MockStoreMockRecorder) ListAuditLogs(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAuditLogs", reflect.TypeOf((*MockStore)(nil).ListAuditLogs), ctx, arg)
}
